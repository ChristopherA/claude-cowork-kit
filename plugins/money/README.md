...
- `money-setup`: Sets up the money binder: the privacy floor, three questions, then categories.md and targets.md as Context documents and the instructions to paste. Use for "set up my money binder", "money setup".

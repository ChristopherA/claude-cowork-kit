...
6. Hand back the list, numbered, and nothing before it. After it, at most: the redirect lines from step 2, one line naming what was left out and why, and one question if a single answer would change the order. Do not ask two.

Do not add encouragement, a summary of what the reader is going through, or a sentence about what the list shows. Do not restate the dump. Do not turn an action into a paragraph.

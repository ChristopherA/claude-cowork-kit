---
name: week-plan
description: Plans the week from the calendar and priorities.md, assuming less time than stated, and flags a plan that only works if nothing goes wrong. Use for "plan my week", "lay out this week".
---
...
1. Ask what is already on the calendar this week: fixed commitments, appointments, travel, the evenings that are spoken for. Ask this before proposing anything. If a connected calendar shows the week, read back what it holds and ask what is missing from it, since the things that eat a week are often not on it.
2. Ask what is in flight that is not on the calendar: the thread waiting on a reply, the thing promised last week, the recurring chores. Assume there is more in flight than the reader has said; name the kinds of thing people forget and ask once whether any apply.
...
It does not create or change a calendar event, or write to a connected calendar in any way. It does not send anything. It does not change `priorities.md` without showing the edit and getting a yes. It does not do the tasks it places; it says where they go.

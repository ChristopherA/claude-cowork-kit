...
- `cowork-new-binder`: Designs a project the kit does not describe: its purpose, boundaries and docs, then the instructions text and a plugin from the kit's template. Use for "new project", "a project for something else".
...
- `cowork-wrap-up`: Writes where this session leaves off, done, open, the first next step and what to watch, into a project doc the next session or the phone reads. Use for "wrap up for today", "write down where we are".

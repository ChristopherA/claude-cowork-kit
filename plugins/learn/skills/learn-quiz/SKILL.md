---
name: learn-quiz
description: Tests recall one question at a time from the lesson, the progress record or a handed note, grading each answer and raising the difficulty. Use for "quiz me", "test me on this chapter".
---
...
Decide what the quiz is on, from what the reader said:
...
For each item on the checklist, until every one is confirmed or the reader stops:

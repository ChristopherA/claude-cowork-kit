...
Everything Claude can reach in a connected folder it may read, and everything it reads goes to the session, which runs in the cloud. Connect the folder the binder is about and only that folder.

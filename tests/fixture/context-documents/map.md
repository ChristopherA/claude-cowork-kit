...
I read more than I write and I lose what I read. The notes are for finding it again and for noticing when two things I read connect. I work at a desk most days and capture from my phone on walks.
...
- what makes a note worth keeping — three candidate tests, the link test leading
- why capture and filing are different — not started
...
I don't use tags. Abandoned books still get a note in sources/. My own reactions in a source note are marked "My take:".

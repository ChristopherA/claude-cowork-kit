...
Plugins for Claude Cowork users who are not programmers: a core plugin with the setup interview and the cross-cutting skills, one plugin per project with its own install skill, and the explainer under `docs/` that every plugin's paste blocks are generated from. See README.md for the layout.

<!-- workstream-kit:begin -->

...
- One document per project under [`docs/projects/`](docs/projects/): [notes](docs/projects/notes.md), [learning](docs/projects/learning.md), [your week](docs/projects/week.md), [money](docs/projects/money.md) and [medical records](docs/projects/medical.md), each with the project's use case, its skills and when to reach for each, its setup, a check that it works, and the text its setup writes, printed so you can read it first or paste it by hand with no plugin at all.
